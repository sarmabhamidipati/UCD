...
(Remember that the word "success" just means that the Bernoulli trial evaluates to True, i.e.,
...
Then, you will plot a histogram describing the probability of the number of defaults.
    ...
    perform_bernoulli_trials() function. It accepts two arguments: the number of trials n -
    ...
    Plot a histogram of n_defaults. Include the normed=True keyword argument so that the height of the bars of the
    histogram indicate the probability.
    Show your plot.

"""
import e19_the_np_random_module_and_bernoulli_trials
...
for i in range(1000):
    n_defaults[i] = e19_the_np_random_module_and_bernoulli_trials.perform_bernoulli_trials(100, 0.05)

# Plot the histogram with default number of bins; label your axes
_ = plt.hist(n_defaults, bins=10)
