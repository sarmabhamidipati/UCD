...
100 XP
    ...
    Compute the mean of all alive sperm counts. To do this, first concatenate control and treated and take the
    mean of the concatenated array.
...
bs_reps_control = draw_bs_reps.draw_bs_reps(control_shifted,
                               np.mean, size=10000)
bs_reps_treated = draw_bs_reps.draw_bs_reps(treated_shifted,
                               np.mean, size=10000)
