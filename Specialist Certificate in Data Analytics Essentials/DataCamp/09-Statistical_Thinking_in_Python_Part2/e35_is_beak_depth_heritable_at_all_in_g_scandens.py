...
100 XP
    ...
    Write a for loop to generate your replicates.
        ...
        Compute the heritability between the permuted array and the bd_offspring_scandens array using the
        heritability() function you wrote in the last exercise. Store the result in the replicates array.
...
heritability_scandens = 0.5485340868685982
...
for i in range(10000):
    ...
    perm_replicates[i] = heritability.heritability(bd_parent_permuted,
