...
x, y = computing_ecdf.ecdf(nohitter_times)

# Create a CDF from theoretical samples: x_theor, y_theor
x_theor, y_theor = computing_ecdf.ecdf(inter_nohitter_time)
...
x_half, y_half = computing_ecdf.ecdf(samples_half)
x_double, y_double = computing_ecdf.ecdf(samples_double)
