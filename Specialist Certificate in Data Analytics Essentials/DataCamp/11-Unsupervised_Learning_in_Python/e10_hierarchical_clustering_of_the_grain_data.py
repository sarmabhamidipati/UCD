...
Hierarchical clustering of the grain data
 ...
 visualize the result. A sample of the grain measurements is provided in the array samples,
...
100 XP
    ...
    Plot a dendrogram using the dendrogram() function on mergings. Specify the keyword arguments labels=varieties,
    leaf_rotation=90, and leaf_font_size=6.
