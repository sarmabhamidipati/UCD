...
TfidfVectorizer from sklearn. It transforms a list of documents into a word frequency array, which it outputs
...
100 XP
    ...
    calling the .get_feature_names() method of tfidf, and assign the result to words.
